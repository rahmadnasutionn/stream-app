                ...
                <div class="pt-[85px] flex flex-col items-center gap-5">
                    ...
                    <div class="mt-[70px] flex justify-center gap-[40px] flex-wrap">
                        ...
                        <div class="pricing-card">
                            ...
                            <form action="{{ route('member.transaction.store') }}" method="POST" class="m-auto">
                                @csrf
                                <input type="hidden" name="package_id" value="{{ $standard->id }}">
                                <button type="submit" class="mt-10 py-3 px-10 hover:bg-indigo-800 transition-all duration-200 block bg-indigo-600 rounded-full text-center">
                        ...
                        <form action="{{ route('member.transaction.store') }}" method="POST" class="m-auto">
                            ...
                            <button type="submit" class="mt-10 py-3 px-10 block bg-indigo-600 rounded-full text-center">
                                <span class="text-white text-base font-semibold">
                                    Subscribe
                                    Now
                                </span>
