            ...
            <div class="pt-[30px] relative">
                ...
                <div class="pt-[85px] flex flex-col items-center gap-5 px-3">
                    ...
                    <section class="w-11/12 max-w-[460px]">
                        <form action="{{ route('member.sign_in.auth') }}" method="POST" class="mt-[70px] flex flex-col bg-white p-[30px] rounded-2xl gap-6">
                            @csrf
                            ...
                            {{-- <a href="index.html" class="bg-indigo-600 rounded-full py-3 mt-4 text-center">
                             ...
                             <button type="submit" class="bg-indigo-600 rounded-full py-3 mt-1 text-center">
                                <span class="font-semibold text-white text-base">Continue</span>
                            </button> 
                            <span class="text-center">OR</span>
                            <a href="{{ route('member.sign_up') }}" class="bg-indigo-600 rounded-full py-3 mt-1 text-center">
