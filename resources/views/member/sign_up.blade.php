            ...
            <div class="pt-[30px] relative">
                ...
                <div class="pt-[85px] flex flex-col items-center gap-5 px-3">
                    ...
                    <section class="w-11/12 max-w-[460px]">
                        <form action="{{ route('member.sign_up.store') }}" method="POST" class="mt-[70px] flex flex-col bg-white p-[30px] rounded-2xl gap-6">
                            @csrf
                            ...
                            <a href="{{ route('member.sign_in') }}" class="bg-indigo-600 rounded-full py-3 text-center">
                                <span class="font-semibold text-white text-base">Sign in</span>
                            </a>
                        </form>
                    </section>
                </div>
